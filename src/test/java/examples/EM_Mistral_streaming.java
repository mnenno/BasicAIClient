...
public class EM_Mistral_streaming {
    ...
    public static void main(String[] args) {
        ...
        if (api != null && api.getApiKeyValue() != null) {
            ...
            messages.add(new AiMessage("user", "What vacation destinations in France are quite fresh even in summer?"));
            ...
            AiRequest aiRequest = new AiRequest.Builder()
                    .model(api.getModel("mistral-small-latest"))
                    .messages(messages)
                    .temperature(0.7)
                    .stream(true)
                    .build();
